package org.ousat.fftpclient.utils;
/**
 * TxQueue Class
 * 
...
public class TxQueue {
	...
	/**
	 * @return a String representation of the first and last segment sequence numbers in
	 * the queue
	 */
	public String toString() {
		if ( isEmpty() ) {
			...
			return "[" + toArray()[ 0 ].getSeqNum() + "-" + toArray()[ size() - 1 ].getSeqNum() + "]";
		}
	}
